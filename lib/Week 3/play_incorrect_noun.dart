...
class PLay_Incorrect_Nouns extends StatefulWidget {
  final List<Map<String, dynamic>> incorrectQuestions;

  var score1;

  PLay_Incorrect_Nouns({Key? key, required this.incorrectQuestions, required this.score1})
      : super(key: key);

  @override
  State<PLay_Incorrect_Nouns> createState() =>
      _PLay_Incorrect_NounsState();
}

class _PLay_Incorrect_NounsState
    extends State<PLay_Incorrect_Nouns> {
