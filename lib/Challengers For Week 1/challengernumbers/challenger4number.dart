...
class Challenger4Number extends StatelessWidget {
  Challenger4Number({required this.score});
...
class _ThirdGameState extends State<ThirdGame> {
  int attempts = 0;
  List<String> availableLetters = ["9", "7", "1", "2"];
  ...
  void checkSolution() {
    if (const ListEquality().equals(solution, ["2"])) {
      setState(() {
