...
class LearnGreetings extends StatefulWidget {
  const LearnGreetings({super.key});

  @override
  _LearnGreetingsState createState() => _LearnGreetingsState();
}

class _LearnGreetingsState extends State<LearnGreetings> {
    ...
    try {
      ...
      if (user != null) {
        ...
        await FirebaseFirestore.instance.collection('users').doc(uid).set({
          'LearnGreetings': 20, // Store the score
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Let's Learn Greetings"),
  ...
  Widget build(BuildContext context) {
    return Scrollbar(
      ...
      child: SingleChildScrollView(
        ...
        child: Center(
          child: Align(
            alignment: Alignment.center, // Centering the cards horizontally
                    ...
                    child: Row(
                      ...
                      children: alphabetImages.map((imageName) {
                        return Padding(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center, // Centering cards vertically
                            children: [
                              Card(
                                elevation: 6.0,
                                color: Colors.white,
                                ...
                                child: ClipRRect(
                                  ...
                                  child: SizedBox(
                                    width: 300,
                                    height: 400, // Increased height for GIF cards
                                    child: FutureBuilder<Widget>(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                                          ...
                                          return Container(
                                            width: 300,
                                            height: 400, // Adjusted height to match the new card size
                                            color: Colors.grey,
                                            child: const Center(
                              ...
                              const SizedBox(height: 16.0), // Spacing after each card
                            ],
                          ),
                        );
                      }).toList(),
