...
class PLay_Incorrect_Verbs extends StatefulWidget {
  ...
  @override
  State<PLay_Incorrect_Verbs> createState() =>
      _PLay_Incorrect_VerbsState();
}

class _PLay_Incorrect_VerbsState
    extends State<PLay_Incorrect_Verbs> {
              ...
              child: Align(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "Identify the below signs of Greetings",
                      style: TextStyle(
                        color: Colors.white,
