import 'dart:math';
import 'package:SignEase/Bonus_Week/quiz.dart';
import 'package:SignEase/Bonus_Week/true_false.dart';
...
class Bonus_Week_Entry extends StatefulWidget {
  ...
  @override
  State<Bonus_Week_Entry> createState() => _Bonus_Week_EntryState();
}

class _Bonus_Week_EntryState extends State<Bonus_Week_Entry> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildCard2(
                        ...
                        title: 'Review Maths Operators',
                        index: 0,
                      ),
                      SizedBox(height: screenHeight * 0.015),
                      _buildCard(
                        onTap: () => _handleCardTap(1, QuizFibGame()),
                      ...
                      SizedBox(height: screenHeight * 0.015),
                      _buildCard(
                        onTap: () => _handleCardTap(2, TrueFalseGame()),
                        imagePath: 'images/true_false.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: ' True or False !',
                        description:
                        "Identify if the answer is correct or not",
                        index: 2,
                      ),
