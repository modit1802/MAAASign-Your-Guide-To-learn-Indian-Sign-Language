import 'package:SignEase/Challengers_All_Weeks/challenger_Week4/DetailedProgressWeek4.dart';
...
class Result_Challenger_Week4 extends StatefulWidget {
  final int score;
  final List<Map<String, dynamic>> incorrectquestions;
  const Result_Challenger_Week4({Key?key, required this.score, required this.incorrectquestions}): super(key: key);


  @override
  State<Result_Challenger_Week4> createState() =>
      _Result_Challenger_Week4State();
}

class _Result_Challenger_Week4State extends State<Result_Challenger_Week4> {
          ...
          children: [
            ...
            _buildCard(
              onTap: () => _handleCardTap(
                ...
                widget.score > 600
                    ? InitialPage1()
                    : Week4Entry(), // Navigate based on score
              ),
              ...
              description: widget.score > 600
                  ? "Congratulations! You have completed Week 4, now it's time to wait for new weeks. Press me to directly go to home page."
