...
void initState() {
  ...
  _controller = VideoPlayerController.network(
    'https://res.cloudinary.com/dfph32nsq/video/upload/v1732626802/Challenger_Week3_axejnt.mp4' // Replace with your video URL or asset
  )
    ..initialize().then((_) {
      setState(() {
...
Widget _buildCard2({
  ...
  descriptionPoints: [
    ...
    "3: As you can see Sign of 'EAT' has been dragged and putted in the first box as per spelling of 'EAT LUNCH'",
