...
class Quiz_alphabet_ResultScreen extends StatefulWidget {
  final int score;
  ...
  const Quiz_alphabet_ResultScreen({
    Key? key,
    required this.score,
  ...
  @override
  State<Quiz_alphabet_ResultScreen> createState() =>
      _Quiz_alphabet_ResultScreenState();
}

class _Quiz_alphabet_ResultScreenState
    extends State<Quiz_alphabet_ResultScreen> {
  ...
  if (userId != null) {
    ...
    if (userDoc == null) {
      ...
      await userCollection.update(
        ...
        mongo.modify.set('week.$weekKey.Score_alphabet', {
          'score_alphabet': widget.score,
          'incorrectQuestions_alphabet': widget.incorrectQuestions,
        }),
      );
