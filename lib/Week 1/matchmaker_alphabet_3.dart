...
class Match_maker_alphabet3 extends StatelessWidget {
  final int score;

  const Match_maker_alphabet3({Key? key, required this.score}) : super(key: key);
...
class _AlphabetFruitMatchState extends State<AlphabetFruitMatch> with SingleTickerProviderStateMixin {
  ...
  List<String> alphabetList = ['H', 'I', 'L', 'N', 'Z'];
