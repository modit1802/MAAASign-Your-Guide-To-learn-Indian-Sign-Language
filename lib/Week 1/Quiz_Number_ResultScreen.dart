...
import 'package:SignEase/Week%201/Play_Incorrect_Solution_Numbers.dart';
...
class Quiz_Number_ResultScreen extends StatefulWidget {
  final int score;
  ...
  const Quiz_Number_ResultScreen({
    Key? key,
    required this.score,
  ...
  @override
  State<Quiz_Number_ResultScreen> createState() =>
      _Quiz_Number_ResultScreenState();
}

class _Quiz_Number_ResultScreenState
    extends State<Quiz_Number_ResultScreen> {
