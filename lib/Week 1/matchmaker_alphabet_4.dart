...
class Match_maker_alphabet4 extends StatelessWidget {
  final int score;

  const Match_maker_alphabet4({Key? key, required this.score}) : super(key: key);
...
class _AlphabetFruitMatchState extends State<AlphabetFruitMatch> with SingleTickerProviderStateMixin {
  ...
  List<String> alphabetList = ['K', 'O', 'Q', 'R', 'S'];
