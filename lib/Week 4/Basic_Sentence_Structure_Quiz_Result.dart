...
class Basic_Sentence_Structure_Quiz_Result extends StatefulWidget {
  final int score;
  ...
  const Basic_Sentence_Structure_Quiz_Result({
    Key? key,
    required this.score,
  ...
  @override
  State<Basic_Sentence_Structure_Quiz_Result> createState() =>
      _Basic_Sentence_Structure_Quiz_ResultState();
}

class _Basic_Sentence_Structure_Quiz_ResultState
    extends State<Basic_Sentence_Structure_Quiz_Result> {
  ...
  if (userId != null) {
    ...
    if (userDoc == null) {
        ...
        'week': {
          weekKey: {
            'Score_Basic_Sentence': {
              'score_basic_sentence': widget.score,
              'incorrectQuestions_basic_sentence': widget.incorrectQuestions,
            }
          }
        }
      });
      ...
      await userCollection.update(
        ...
        mongo.modify.set('week.$weekKey.Score_Basic_Sentence', {
          'score_basic_sentence': widget.score,
          'incorrectQuestions_basic_sentence': widget.incorrectQuestions,
        }),
      );
