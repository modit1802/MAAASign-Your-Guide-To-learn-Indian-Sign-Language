...
import 'Basic_Sentence_Structure_FIB.dart';
class Basic_Sentence_Structure extends StatefulWidget {
  const Basic_Sentence_Structure({super.key});

  @override
  State<Basic_Sentence_Structure> createState() => _Basic_Sentence_StructureState();
}

class _Basic_Sentence_StructureState extends State<Basic_Sentence_Structure> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildCard2(
                        onTap: () => _handleCardTap(0, const Learn_Basic_Sentence_Structure()),
                      ...
                      const SizedBox(height: 12),
                      _buildCard(
                        onTap: () => _handleCardTap(2, Basic_Sentence_Structure_FIB()),
                        imagePath: 'images/bingo.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: 'Fill in the Blanks!',
                        description: "Guess the missing word in the sentence",
                        index: 2,
                      ),
                      const SizedBox(height: 12),
                    ],
