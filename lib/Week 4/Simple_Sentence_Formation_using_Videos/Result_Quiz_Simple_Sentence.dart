...
class Quiz_Simple_Sentence_ResultScreen extends StatefulWidget {
  final int score;
  ...
  const Quiz_Simple_Sentence_ResultScreen({
    Key? key,
    required this.score,
  ...
  @override
  State<Quiz_Simple_Sentence_ResultScreen> createState() =>
      _Quiz_Simple_Sentence_ResultScreenState();
}

class _Quiz_Simple_Sentence_ResultScreenState
    extends State<Quiz_Simple_Sentence_ResultScreen> {
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        Play_incorrect_simple_sentences(
                                          incorrectQuestions:
                                              widget.incorrectQuestions,
                                          score1: widget.score,
                                        )));
