...
class Bingo_Simple_Sentence_ResultScreen extends StatefulWidget {
  final int score;
  ...
  const Bingo_Simple_Sentence_ResultScreen({
    Key? key,
    required this.score,
  ...
  @override
  State<Bingo_Simple_Sentence_ResultScreen> createState() =>
      _Bingo_Simple_Sentence_ResultScreenState();
}

class _Bingo_Simple_Sentence_ResultScreenState
    extends State<Bingo_Simple_Sentence_ResultScreen> {
    ...
    if (userId != null) {
      ...
      if (userDoc == null) {
        ...
        await userCollection.insert({
          ...
          'week': {
            weekKey: {
              'Score_bingo_simple_sentence': {
                'score_bingo_simple_sentence_2': widget.score,
                'incorrectQuestions_bingo_game_2': widget.incorrectQuestions,
        ...
        await userCollection.update(
          ...
          mongo.modify.set('week.$weekKey.Score_bingo_simple_sentence', {
            'score_bingo_simple_sentence_2': widget.score,
            'incorrectQuestions_bingo_game_2': widget.incorrectQuestions,
          }),
        );
