...
import 'package:SignEase/Week%204/Basic_Sentence_Structure_FIB.dart';
import 'package:SignEase/Week%204/Review_Mistakes.dart';
import 'package:SignEase/Week%204/Retry_FIB.dart';
...
class Basic_Sentence_Structure_FIB_Result extends StatefulWidget {
  final int score;
  ...
  const Basic_Sentence_Structure_FIB_Result({
    Key? key,
    required this.score,
  ...
  @override
  State<Basic_Sentence_Structure_FIB_Result> createState() =>
      _Basic_Sentence_Structure_FIB_ResultState();
}

class _Basic_Sentence_Structure_FIB_ResultState
    extends State<Basic_Sentence_Structure_FIB_Result> {
    ...
    if (userId != null) {
      ...
      if (userDoc == null) {
          ...
          'week': {
            weekKey: {
              'Score_Basic_Sentence_FIB': {
                'score_basic_sentence_FIB': widget.score,
                'incorrectQuestions_basic_sentence_FIB': widget.incorrectQuestions,
              }
            }
          }
        });
        ...
        await userCollection.update(
          ...
          mongo.modify.set('week.$weekKey.Score_Basic_Sentence_FIB', {
            'score_basic_sentence_FIB': widget.score,
            'incorrectQuestions_basic_sentence_FIB': widget.incorrectQuestions,
          }),
        );
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: _buildCircularButton(
                              Icons.arrow_back, "Week 4", Colors.pink),
                        ),
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
