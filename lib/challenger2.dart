...
class Challenger2 extends StatelessWidget {
  final int score;
  const Challenger2({super.key, required this.score});
...
class _ThirdGameState extends State<ThirdGame> {
  ...
  void checkSolution() {
    if (const ListEquality().equals(solution, ["O", "I", "L"])) {
      // Correct solution
      setState(() {
        ...
        SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Image.asset("images/Challenger_2.png", width: 300, height: 200),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Challenger3(score:score)));
                  },
