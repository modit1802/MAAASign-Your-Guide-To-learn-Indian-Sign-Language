...
import 'package:SignEase/Week%205/adverb_practice2.dart';
import 'adverb_quiz.dart';
import 'learnadverbs.dart';
class AdverbStartScreen extends StatefulWidget {
  const AdverbStartScreen({super.key});

  @override
  State<AdverbStartScreen> createState() => _AdverbStartScreenState();
}

class _AdverbStartScreenState extends State<AdverbStartScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildCard2(
                        onTap: () => _handleCardTap(0, const LearnAdverbs()),
                        imagePath: 'images/verbs.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: 'Review Signing Adverbs',
                        index: 0,
                      ),
                      const SizedBox(height: 12), // Space between the cards
                      _buildCard(
                        onTap: () => _handleCardTap(1, AdverbQuiz()),
                        imagePath: 'images/quiz.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: 'Pop Quiz !',
                        description: "Identify the correct adverb!",
                        index: 1,
                      ),
                      const SizedBox(height: 12), // Space between the cards
                      _buildCard(
