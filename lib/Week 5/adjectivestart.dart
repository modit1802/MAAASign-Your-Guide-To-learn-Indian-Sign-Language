...
import 'adjective_practice2.dart';
import 'adjective_quiz.dart';
import 'learnadjectives.dart';
class AdjectiveStartScreen extends StatefulWidget {
  const AdjectiveStartScreen({super.key});

  @override
  State<AdjectiveStartScreen> createState() => _AdjectiveStartScreenState();
}

class _AdjectiveStartScreenState extends State<AdjectiveStartScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildCard2(
                        onTap: () => _handleCardTap(0, const LearnAdjectives()),
                        imagePath: 'images/verbs.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: 'Review Signing Adjectives',
                        index: 0,
                      ),
                      const SizedBox(height: 12), // Space between the cards
                      _buildCard(
                        onTap: () => _handleCardTap(1,AdjectiveQuiz()),
                        imagePath: 'images/quiz.png',
                        color: const Color.fromARGB(255, 255, 255, 255),
                        title: 'Pop Quiz !',
                        description: "Identify the correct Adjective!",
                        index: 1,
                      ),
                      const SizedBox(height: 12),
                      _buildCard(
