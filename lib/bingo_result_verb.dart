...
import 'package:SignEase/play_incorrect_verb.dart';
...
class Bingo_verb_ResultScreen extends StatefulWidget {
  final int score;
  ...
  @override
  State<Bingo_verb_ResultScreen> createState() =>
      _Bingo_verb_ResultScreenState();
}

class _Bingo_verb_ResultScreenState
    extends State<Bingo_verb_ResultScreen> {
